...
2. 먼저 프로젝트 zip 파일을 압축해제합니다.
3. 압축해제 한 프로젝트를 IDE 툴로 실행합니다.
4. 사용되는 플러그인이 설치가 완료되기를 기다립니다.
5. 오른쪽 상단에 Run 버튼을 클릭하여 실행합니다.
6. 사이트 주소창에 http://localhost:8080/swagger.html 주소를 입력해 swagger 를 이용하면 됩니다.
